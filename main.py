"""Scrape Pitts listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Pitts Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=pitts&s-original-search=pitts",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=pitts"),
    ("ASO", "https://aso.com/search?q=Pitts"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Pitts Listings</h2>
    <p>View additional Pitts Aircraft listings at these fine sites:</p>
